...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('学習者登録') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="stu_num" class="col-md-4 col-form-label text-md-end">{{ __('学習者番号') }}</label>

                            <div class="col-md-6">
                                <input id="stu_num" type="text" class="form-control @error('stu_num') is-invalid @enderror" name="stu_num" value="{{ old('stu_num') }}" required autocomplete="stu_num" autofocus>

                                @error('stu_num')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{__(' 学習者番号が正しくありません') }}</strong>
                                    </span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{__(' 学習者番号または、パスワードが一致しません。 ') }}</strong>
                                    </span>
                                @enderror
                            </div>
                        </div>
